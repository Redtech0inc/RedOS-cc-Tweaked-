...
<li>Changing the 2 (3 for folders) file name preview letters via a title.json (can be found in system/Ustils/Uninstaller (displayed as ROSUninstaller.exe) folder)
