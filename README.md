...
### main goals
The RedOS tries to be the os connecting newer and older cc devs
it does this through:
<li>easy to use file management, no learning of console commands needed
<li>pre-meade systems (APIs) (idk currently no documentation -v-)
<li>unlimited access (yes this means no sandbox-ing)
...
This is the Beta Version of the RedOS<br>
...
<br>
but Remember any sort of feedback (in comments on pinestore or as issue on the github) can help<br>
